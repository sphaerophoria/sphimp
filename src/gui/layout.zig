...
fn scrollAreaBounds(scrollbar: Scrollbar, window_width: i32, window_height: i32) PixelBBox {
    return .{
        .left = window_width - scrollbar.style.width,
        .right = window_width,
        .top = 0,
...
pub fn Layout(comptime ActionType: type) type {
    return struct {
        ...
        pub fn availableSize(self: *Self, window_size: PixelSize) PixelSize {
            return .{
                .width = window_size.width - self.cursor.x - self.scrollbarWidth(),
        ...
        pub fn dispatchInput(self: *Self, input_state: InputState, window_width: i32, window_height: i32) ActionType {
            ...
            if (self.scrollbar.handleInput(
                input_state,
                scrollAreaBounds(self.scrollbar, window_width, window_height),
            )) |scroll_loc| {
