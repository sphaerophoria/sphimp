...
pub const InputState = struct {
    ...
    frame_scroll: f32 = 0,
    frame_keys: sphutil.RuntimeBoundedArray(KeyEvent),

    pub fn init(alloc: Allocator) !InputState {
        return .{
            .frame_keys = try sphutil.RuntimeBoundedArray(KeyEvent).init(alloc, 100),
        };
    }
