...
pub fn renderDistanceFieldToTexture(self: DistanceFieldGenerator, alloc: Allocator, scratch_gl: *GlAlloc, point_it: anytype, sign_texture: Texture, width: u31, height: u31, out_texture: Texture) !void {
